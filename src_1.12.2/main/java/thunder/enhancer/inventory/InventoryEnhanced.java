package thunder.enhancer.inventory;
...
public class InventoryEnhanced implements IInventory {
	...
	public InventoryEnhanced() {}
	
	@Override
	public String getName() {
		
		return "Enhanced Inventory";
	}
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		...
		if(!stack.isEmpty() && stack.getItem() instanceof IModifiable) return true;
		return false;
	}
	...
	public void copy(InventoryEnhanced inv) {
