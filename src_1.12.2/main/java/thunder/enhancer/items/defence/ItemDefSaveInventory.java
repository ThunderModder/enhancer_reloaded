...
public class ItemDefSaveInventory extends ItemModifier {

	public ItemDefSaveInventory(String ulocalizedName, EnumModifierType type) {
	...
	public void getDescription(ItemStack stack, List<String> tips){
		...
		tips.add(TextFormatting.DARK_GRAY + I18n.format("tooltip.energy", new Object[]{}) + TextFormatting.DARK_PURPLE + Constants.DEF_INVSAVE_BASE * NBTItemProvider.getPower(stack) + " LT");
    }
