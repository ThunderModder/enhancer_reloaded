...
public class ItemDefProtection extends ItemModifier {

	public ItemDefProtection(String ulocalizedName, EnumModifierType type) {
	...
	public void getDescription(ItemStack stack, List<String> tips){
		...
		tips.add(TextFormatting.DARK_GRAY + I18n.format("tooltip.energy", new Object[]{}) + TextFormatting.DARK_PURPLE + Constants.DEF_PROTECTION_BASE * NBTItemProvider.getPower(stack) + " LT");
    }
	
	@Override
	public void onInventoryTick(EntityPlayer player, ItemStack stack) {

		if(NBTItemProvider.discharge(stack, Constants.DEF_PROTECTION_BASE)){
			Utils.addPotionEffect(player, Utils.POTION_RESISTANCE, NBTItemProvider.getPower(stack));
		}
