...
public class ItemDefExtinguish extends ItemModifier {

	public ItemDefExtinguish(String ulocalizedName, EnumModifierType type) {
	...
	public void getDescription(ItemStack stack, List<String> tips){
		...
		tips.add(TextFormatting.DARK_GRAY + I18n.format("tooltip.energy", new Object[]{}) + TextFormatting.DARK_PURPLE + Constants.DEF_EXTINGUISH_BASE * NBTItemProvider.getPower(stack) + " LT");
    }
	
	@Override
	public void onInventoryTick(EntityPlayer player, ItemStack stack) {

		if(player.isBurning() && NBTItemProvider.discharge(stack, Constants.DEF_EXTINGUISH_BASE)){
			player.extinguish();
		}
